...
<div class="main-content text-left">
    ...
    <h3 class="font-normal text-xl py-4">Who is responsible for the collection of data on kimpotterdogtraining.com?</h3>
    <p>
      We are! kimpotterdogtraining.com. Our contact data can be found in the
      <a href="/contact" rel="nofollow" target="_blank">contact page</a>.
    </p>
    ...
    <p>
      ...
      To file a request, simply send a mail to caninetrainerkp@gmail.com.<br>
      <br>
      ...
      If you have any questions please feel free to contact us via caninetrainerkp@gmail.com.<br>
    </p>
    ...
    <p>
      ...
      concerning our Website usage so we can further optimize kimpotterdogtraining.com (see 3.).<br>
    ...
    <p>
      To follow up fraud or malicious use of kimpotterdogtraining.com, we store server log files containing the following data:
    </p>
    <br>
    <ul>
    ...
    <br>
    <p>
      The information will be used to analyze the usage of kimpotterdogtraining.com, to create reports about the user’s activity
      ...
      <a href="http://tools.google.com/dlpage/gaoptout?hl=en" rel="noreferrer noopener nofollow" target="_blank">this browser-plugin</a>.<br>
      <br>
      ...
      <a href="https://support.google.com/analytics/answer/6004245?hl=de" rel="noreferrer noopener nofollow" target="_blank">this Google Help articles</a>
    </p> -->
